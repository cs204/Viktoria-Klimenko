...
знания2.добавить(new Эквивалентность(new Или(АЛжец, БЛжец), БРыцарь))
знания2.добавить(new Эквивалентность(new Или(АРыцарь, БРыцарь), БРыцарь))
...
// В сказал: "А - рыцарь."
let знания3 = new И()
знания3.добавить(new Эквивалентность(АЛжец, БРыцарь))
